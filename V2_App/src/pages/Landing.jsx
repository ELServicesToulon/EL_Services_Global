                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            <div className="inline-flex items-center space-x-2 bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-sm font-semibold">
                                ...
                                <span>Leader de la livraison médicale dans le Var</span>
                            </div>

                            <h1 className="text-5xl lg:text-7xl font-extrabold text-slate-900 leading-tight">
                                La logistique santé <br />
                                <span className="text-blue-600">nouvelle génération</span>
                            </h1>

                            <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
                                Nous assurons le lien vital entre Pharmacies, EHPAD et Patients avec une flotte dédiée, sécurisée et traçable en temps réel sur Toulon et sa région.
                            </p>
            ...
            <section id="services" className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">Nos Solutions de Transport</h2>
                        <p className="text-lg text-gray-600">Une réponse adaptée à chaque besoin critique du secteur médical.</p>
                    </div>
