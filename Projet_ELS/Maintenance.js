...
function getBaseSheetExpectations_() {
  return [
    ...
    { name: SHEET_ETABLISSEMENTS, headers: [COLONNE_TYPE_ETAB, COLONNE_NOM_ETAB, COLONNE_ADRESSE_ETAB, COLONNE_CODE_POSTAL_ETAB, COLONNE_VILLE_ETAB, COLONNE_CONTACT_ETAB, COLONNE_TELEPHONE_ETAB, COLONNE_EMAIL_ETAB, COLONNE_SITE_WEB_ETAB, COLONNE_JOURS_ETAB, COLONNE_PLAGE_ETAB, COLONNE_SOURCE_ETAB, COLONNE_STATUT_ETAB, COLONNE_DERNIERE_MAJ_ETAB, COLONNE_NOTE_ETAB, COLONNE_PLACE_ID_ETAB], required: false },
