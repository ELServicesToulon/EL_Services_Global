/**
 * Backend_Handler.gs
 * Copie locale de la logique backend pour l'application autonome App_Livreur.
 * Permet à l'application de fonctionner sans dépendance de bibliothèque complexe.
 */
